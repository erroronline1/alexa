	...
	class answers{
		...
		public function get($chunk, ...$param){
			$answers= [
				...
				'errortimelimit' => [		'de' => 'tut mir leid, amazon erlaubt keine kürzeren intervalle als 4 oder längere als 24 stunden in diesem zusammenhang.',
											'en' => 'i am sorry, amazon does not allow intervals less than 4 or more than 24 hours in this context.'],
				...
				'unset_reprompt' => [		'de' => 'soll ich eine erinnerung beenden, hinzufügen oder ändern?',
											'en' => 'shall i cancel, add or change a reminder?'],
				'conjunction' => [			'de' => 'und',
											'en' => 'and'],
				'every'	=> [				'de' => 'alle',
											'en' => 'every'],
				...
				'reminders' => [			'de' => 'zur zeit erinnere ich dich ' . $param[0] . '. wenn ich etwas beenden, hinzufügen oder ändern soll sage zum beispiel: beende erinnerung für ' . $param[1] . ' oder: erinnere mich an trinken',
											'en' => 'currently i remind you ' . $param[0] . '. if i should stop, start or change a reminder say something like: stop reminding me of ' . $param[1] . ' or: remind me to drink'],
